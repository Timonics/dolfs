  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex space-y-25 flex-col lg:mt-20 justify-center p-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-4xl mx-auto w-full place-items-center">
          {services.map((item) => (
        ...
        <div className="flex flex-col gap-4 items-center">
          {additionalServices.map((service) => (
            <div className="flex items-start gap-4 p-2 w-full">
              <div className="h-20 w-24 rounded-xl bg-black/10 shadow-xl" />
      ...
      <div className="max-w-lg mx-auto w-full p-4 flex flex-col items-center gap-6 lg:bg-black shadow-2xl lg:text-white">
